...
static uint8_t buffer[SSD1306_LCDHEIGHT * SSD1306_LCDWIDTH / 8] = { 0x00, 0x00,
		...
		0x00, 0x00, 0x00, 0x80, 0x80, 0x80, 0x80, 0x80, 0x00, 0xFF,
...
Adafruit_SSD1306::Adafruit_SSD1306(uint8_t _rst) :
		Adafruit_GFX(SSD1306_LCDWIDTH, SSD1306_LCDHEIGHT) {
	sclk = dc = cs = sid = -1;
	rst = _rst;
}

void Adafruit_SSD1306::seti2c(I2C_HandleTypeDef *_i2c) {
	oledi2c = _i2c;
}
...
void Adafruit_SSD1306::ssd1306_command(uint8_t c) {
	...
	buf[0] = control;
	buf[1] = c;
	HAL_I2C_Master_Transmit(oledi2c, (uint16_t) _i2caddr,&buf[0],2, 100);
	//HAL_I2C_Mem_Write(i2c, _i2caddr, 0x00, I2C_MEMADD_SIZE_8BIT, &buf[0], 2, 100);
}
...
void Adafruit_SSD1306::display(void) {
	...
	for (uint16_t i = 0; i < (SSD1306_LCDWIDTH * SSD1306_LCDHEIGHT / 8); i++) {
		...
		i--;
		//HAL_I2C_Mem_Write(i2c, (uint16_t) _i2caddr, 0x00, I2C_MEMADD_SIZE_8BIT,
		//		&buf[0], 17, 100);
		HAL_I2C_Master_Transmit(oledi2c, (uint16_t) _i2caddr,&buf[0],17, 100);
	}
}
